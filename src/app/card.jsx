...
export default function Card({ value, temperature, status }) {
  ...
  const backgroundColor = value === "night" ? "bg-[#111827BF]" : "bg-white";
  return (
    <div className={`w-[414px] h-[832px] rounded-[48px] flex flex-col ${manrope.className} ${backgroundColor}`} >
      <div className={`w-[398px] h-[504px] bg-white rounded-[42px] mt-[8px] ${color} flex flex-col mx-auto`} >
        ...
        <img src="/nightCloud.png" className="w-[264.89px] h-[264.89px] mx-auto drop-shadow-[0_5px_25px_rgba(255,255,255,0.5)] mt-[24px] "
        />
      </div>
      <div className="ml-[48px] -mt-[50px]">
        <h1 className={`text-[144px] font-extrabold text-transparent bg-clip-text ${gradient}`} >
          {temperature}
        </h1>
